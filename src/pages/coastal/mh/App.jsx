        ...
        <div className="flex flex-col md:flex-row md:space-x-12 items-start">
          <div className="md:w-1/3 mb-6 md:mb-0">
            ...
            <p className="text-gray-800 leading-relaxed mt-3 text-[16px]">
              ...
              areas where the mountains are high enough, the MH zone transitions
              into the treeless alpine meadows of the Coastal Mountain Heather
              Alpine zone.
            </p>
          </div>
        ...
        <div className="max-w-screen-lg mx-auto flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2">
            ...
            <p className="text-[16px] leading-relaxed">
              Mountain Hemlock zones experience heavy snowfall and cool summers.
              Climate is a key driver of the vegetation distribution, as shown
              in the seasonal temperature and precipitation graph below.
            </p>
          </div>
      ...
      <div className="px-4 py-12 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          <div className="w-full md:w-1/3">
            <img src="/subzone-1.png" alt="Subzone 1" className="rounded-lg" />
            <p className="mt-2 text-sm text-center italic">
              Windward Moist Subzone
            </p>
          </div>
          <div className="w-full md:w-1/3">
            <img src="/subzone-2.png" alt="Subzone 2" className="rounded-lg" />
            <p className="mt-2 text-sm text-center italic">
