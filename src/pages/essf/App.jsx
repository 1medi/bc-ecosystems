    ...
    <>
      <PageWrapper>
        ...
        <section className="flex flex-col m-8 p-8 max-w-screen-lg mx-auto bg-[#556B2F]/15 rounded-xl shadow-xl">
          ...
          <p className="font-body-copy p-2">
            This seemingly harsh environment surprisingly fosters high
            biodiversity, supporting a diverse array of shrubs, herbs, and
            climax forests dominated by Engelmann Spruce (Picea engelmannii) and
            Subalpine Fir (Abies lasiocarpa). Notably, these resilient trees can
            live for centuries, a testament to their adaptation to cold
            climates. The ESSF zone's unique combination of biodiversity,
            climate, and vast scale makes it a compelling area for biological
            research and a popular destination for year-round recreation.
          </p>
        </section>

        <section className="flex flex-col p-8 max-w-screen-lg  m-8 mx-auto bg-[#556B2F]/15 rounded-xl shadow-xl">
          <h2 className="text-center font-regular-header text-green-900 text-center">
            Distribution
          </h2>
          <div className="border-b border-4 border-green-950 my-3 rounded-xl " />
          <p className="font-body-copy p-2">
          ...
          <p className="font-body-copy p-2">
            As BC's uppermost forested zone, it covers about 18.6% (17.6 Mha) of
            the province, typically found in steep, rugged mountainous terrain
            at subalpine elevations ranging from 900-2300 m (varying by region).
            Situated above several other forest zones (MS, ICH, SBS, BWBS, CWH)
            and below alpine zones (BAFA, IMA, CMA), the ESSF sweeps across much
            of BC, from the southeast to the far northwest, and is common in the
            Coast Mountains' rainshadow.
          </p>
          <p className="font-body-copy p-2">
            It is less prevalent or absent in coastal, central, and northern
        ...
        <section className="flex flex-col flex-wrap gap-8 m-8 p-8 max-w-screen-lg mx-auto bg-[#556B2F]/15 rounded-xl shadow-xl">
          <div className="flex-1 min-w-[300px]">
            <h2 className="text-2xl text-center font-regular-header text-green-900 mb-4 text-center">
              Climate
            </h2>
            <div className="border-b border-4 border-green-950 my-3 rounded-xl " />
            <div className="flex flex-col md:flex-row">
              <p className="font-body-copy p-2 md:w-1/2">
                ...
                degrees latitude, the ESSF zone experiences long, cold winters
                and short, cool summers. While climate varies across its
                extensive range, the mean annual temperature generally falls
                between -2 and 2 °C, with 5-7 months below freezing and only
                about two months exceeding 10 °C. Mean annual precipitation
                ranges significantly from 400-2200 mm, with December being the
                wettest and May the driest month.
              </p>
              <p className="font-body-copy p-2 md:w-1/2">
                A substantial 50-70% of precipitation falls as snow, resulting
                in a winter snowpack of 1-4 m that provides crucial water
                storage for lower elevations during spring and early summer. The
                short snow-free period (as little as 110 days at higher
                ...
                factors like soil, slope, aspect, and vegetation create
                important microclimates that influence sunlight and water
                availability, further impacting growing conditions often
                described as "harsh" and "severe" at higher elevations.
              </p>
            </div>
          </div>
          <div className="flex-1 min-w-[300px]">
        ...
        <section className=" m-8 p-8 max-w-screen-lg mx-auto bg-[#556B2F]/15 rounded-xl shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {/* Column 2 - Top Right */}
            <div className="bg-emerald-50 border border-emerald-700 rounded-md p-4 italic text-emerald-900 shadow-sm h-fit self-start m-auto">
