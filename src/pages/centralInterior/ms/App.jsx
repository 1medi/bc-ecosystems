          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="md:w-1/2">
              ...
              <p className="text-base leading-relaxed">
                The MS zone was formally recognized in the mid to late 1970s by
                the BCMoF Research Branch. It was initially observed as an
                ecotone between the IDF and ESSF, particularly in the Cariboo
                Mountains, but was later distinguished due to its unique
                characteristics. Its ecosystems are now identified in various
                parts of BC's Central Interior, expanding northward and
                eastward.
              </p>
            </div>
            <div className="md:w-1/2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-base leading-relaxed mb-4">
                Common throughout the MS zone are lodgepole pine seral plant
                communities, often established following wildfire. These forests
                are crucial for timber supply and are ecologically adapted to
                frequent disturbance. The zone supports grazing practices,
                particularly during summer, under lodgepole pine canopy with a
                pinegrass-dominated understory.
              </p>
