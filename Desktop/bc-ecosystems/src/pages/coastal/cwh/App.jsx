...
export default function CWHPage() {
  return (
    <>
      ...
      <AboutZoneCard
        title="What is the Coastal Western Hemlock Zone?"
        description="The Coastal Western Hemlock (CWH) zone is the largest of BC’s coastal biogeoclimatic zones. Found along the Pacific Coast, it is characterized by mild, wet winters and cool summers. The zone features dense, multi-layered conifer forests with species like Western hemlock, Western redcedar, and amabilis fir. Mosses, ferns, and shrubs dominate the moist forest floor, and its high productivity makes it crucial for biodiversity, carbon storage, and forest industries."
        image="/CWH-zone.png"
      />
            <section className="flex flex-wrap gap-8 p-8 max-w-screen-lg mx-auto">
        <div className="flex-1 min-w-[300px]">
          <h2 className="text-2xl font-bold text-green-900 mb-4">Where it grows</h2>
          <p className="text-base text-gray-800 leading-relaxed">
          Western Hemlock is the most widespread and abundant tree species along the coast of British Columbia. It thrives from sea level to mid-elevation, growing on both the eastern and western slopes of the Coast Mountains, and even extends inland into the wet belt of the Interior, west of the Rocky Mountains.
Rather than forming pure stands, Western Hemlock typically grows in mixed forests alongside species like Douglas-fir, Amabilis fir, Sitka spruce, and Western redcedar. While it can occasionally form pure stands—especially after large-scale windthrow—it more often flourishes in the understory thanks to its high shade tolerance.
Due to its shallow root system, Western Hemlock is vulnerable to being uprooted by strong winds and damaged by wildfires, but it regenerates quickly in moist, shaded environments, often forming dense young growth beneath mature canopies.
          </p>

          <h2 className="text-2xl font-bold text-green-900 mt-8 mb-4">Location & Distribution</h2>
          <p className="text-base text-gray-800 leading-relaxed">
          <ul>
  <li>Found along the entire BC coast, Vancouver Island, Haida Gwaii, and the Coast Mountains</li>
  <li>Extends into river valleys (e.g., Fraser, Skeena) and parts of Alaska & Washington/Oregon</li>
  <li>
    Elevation:
    <ul>
...
These cool, moist conditions support lush forests, dense moss layers, and high biodiversity, making the CWH zone one of BC’s most productive ecosystems.
          </p>
        </div>
      </section>
      <section className="p-8 max-w-screen-lg mx-auto">
        <h2 className="text-2xl font-bold text-green-900 mb-4 text-center">Forest Variation Across the Coastal Western Hemlock Zone</h2>
        <p className="text-base text-gray-800 leading-relaxed">
  ...
  <div className="basis-1/3">
    ...
    <p className="text-base text-gray-800 leading-relaxed">
      Annual rainfall ranges from ~1300 mm to nearly 3000 mm, with the CWHvh being the wettest. Summer is generally drier, but all subzones still receive some rain.
    </p>
  </div>
  <div className="basis-1/3">
    <h2 className="text-2xl font-bold text-green-900 mb-4 text-center">Growing season:</h2>
    <p className="text-base text-gray-800 leading-relaxed">
      Most subzones have 4 to 6 months where temperatures exceed 10°C.<br />
      <strong>Continentality:</strong> Values range from 2 to 7, showing how inland subzones experience more temperature variation.
    </p>
  </div>
  <div className="basis-1/3">
    <h2 className="text-2xl font-bold text-green-900 mb-4 text-center">Temperature:</h2>
    <ul className="list-disc pl-6 text-base text-gray-800 leading-relaxed space-y-1">
      ...
      <li>Coldest month: as low as −6.0°C in interior subzones like CWHws.</li>
    </ul>
  </div>
</section>
